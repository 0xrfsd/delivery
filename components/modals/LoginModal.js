      ...
      <>
        {esqueceu ? (
          <View style={{ paddingLeft: 20, paddingRight: 20 }}>
            ...
            :<Text style={{ color: "#333", fontWeight: "bold" }}>Qual é o seu email?</Text>
            }
            <Text style={{ color: "#333" }}>
              Iremos enviar um email com um link para que você possa redefinir
              sua senha
            </Text>
            {email
            ? null
            ...
            >
              ...
              >
                <Text style={{ color: "#fff" }}>
                  {esqueceuEnviado ? 'Reenviar email de recuperação' : 'Enviar email de recuperação' }
  ...
  return (
    <>
      <Modalize
        ...
        modalHeight={
          email ? esqueceu ? keyboardAvoid ? modalHeight - 20 - 50 + keyboardHeight : modalHeight - 20 - 50 : keyboardAvoid ? modalHeight + keyboardHeight : modalHeight : esqueceu ? keyboardAvoid ? modalHeight - 20 + keyboardHeight : modalHeight - 20 : keyboardAvoid ? modalHeight + keyboardHeight : modalHeight
        }
